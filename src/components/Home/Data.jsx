...
const Data=()=>{
    ...
    return (
       <div className="home__data">
        <h1 className="home__title">Mantosh
        ...
        I'm a creative and passionate Web Developer dedicated to building innovative, user-friendly websites and applications. With a strong foundation in front-end and back-end technologies, 
        </p>
